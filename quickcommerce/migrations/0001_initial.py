# Generated by Django 5.1.1 on 2025-01-01 01:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagline', models.CharField(blank=True, default='', max_length=555, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('order_no', models.CharField(editable=False, max_length=5, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('rapparelid', models.CharField(blank=True, max_length=255, null=True, unique=True)),
                ('name', models.CharField(max_length=255, unique=True)),
                ...
                ('subcategory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subproducts', to='quickcommerce.category')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('status', models.CharField(choices=[('initiated', 'Initiated'), ('completed', 'Completed'), ('failed', 'Failed')], max_length=50)),
                ('refund_date', models.DateTimeField(auto_now_add=True)),
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='refunds', to='quickcommerce.payment')),
            ],
        ),
        migrations.CreateModel(
            name='ReturnRequest',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('rapparelid', models.CharField(default=1, max_length=255, unique=True)),
                ('name', models.CharField(max_length=255, unique=True)),
                ...
                ('banner_image', models.ImageField(blank=True, null=True, upload_to='store_images/banners/')),
                ('inventory_software', models.CharField(choices=[('excel', 'Excel'), ('wizapp', 'Wizapp')], max_length=255)),
                ...
                ('api_refresh_token', models.CharField(blank=True, max_length=255, null=True)),
                ('api_token_expiry', models.DateTimeField(blank=True, null=True)),
                ('api_client_id', models.CharField(blank=True, max_length=255, null=True)),
                ('api_client_secret', models.CharField(blank=True, max_length=255, null=True)),
                ('wizapp_groupcode', models.CharField(blank=True, max_length=255, null=True)),
                ('wizapp_apikey', models.CharField(blank=True, max_length=255, null=True)),
                ('wizapp_userid', models.CharField(blank=True, max_length=255, null=True)),
                ('wizapp_password', models.CharField(blank=True, max_length=255, null=True)),
